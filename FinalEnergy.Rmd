...
```{r}
EnergyDataAggregate$HighEnergyUse <- ifelse(EnergyDataAggregate$GENERAL_SUPPLY_KWH>mean(EnergyDataAggregate$GENERAL_SUPPLY_KWH),1,0)
...
#tune.out=tune(svm, HighEnergyUse~DAY+MONTH+DAYNAME+HOUR,data=energyData.full,kernel="linear",ranges=list(cost=c(0.001, 0.01, 0.1, 1,5,10,100)))
